...
export default class SpacesLocationsSet extends SpacesBaseCommand {
  ...
  async run(): Promise<void> {
    ...
    try {
      ...
      if (!location) {
        // Should not happen if parsing succeeded, but for type safety
            ...
            if (this.subscription) {
              try {
                this.logCliEvent(
                  ...
                  "location",
                  "unsubscribing",
                  "Unsubscribing from location events",
                );
                ...
                this.logCliEvent(
                  ...
                  "location",
                  "unsubscribed",
                  "Successfully unsubscribed from location events",
                );
              } catch (error) {
                this.logCliEvent(
                  flags,
            ...
            if (this.space) {
              try {
                ...
                this.logCliEvent(
                  ...
                  "location",
                  "clearing",
                  "Clearing location by setting to null",
                );
                await this.space.locations.set(null);
                this.logCliEvent(
                  flags,
