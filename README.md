...
_See code: [src/commands/mcp/index.ts](https://github.com/ably/cli/blob/v0.3.0/src/commands/mcp/index.ts)_
...
_See code: [src/commands/mcp/start-server.ts](https://github.com/ably/cli/blob/v0.3.0/src/commands/mcp/start-server.ts)_
