...
export default class SpacesLocationsIndex extends Command {
  static override description = 'Commands for location management in Ably Spaces'
  ...
  async run(): Promise<void> {
    ...
    this.log('')
    this.log('Run `ably spaces locations COMMAND --help` for more information on a command.')
  }
} 